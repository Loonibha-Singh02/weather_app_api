...
class _HomeScreenPageState extends State<HomeScreenPage> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((SharedPreferences prefs) {
      setState(() {
        this.prefs = prefs;
        // Retrieve and set the saved location name
  ...
  Future<void> fetchWeather(String city, {double? latitude, double? longitude}) async {
  ...
  Future<void> _showErrorDialog() async {
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Failed to load weather"),
        actions: [
          TextButton(
            onPressed: () {
                            ...
                            suffixIcon: CustomButtons(
                              onPressed: () async {
                                if (controller.text.isEmpty) {
                                  ...
                                  await fetchWeather(controller.text);
                                  setState(() {
                                    buttonLabel = 'Update';
                                  });
                                }
